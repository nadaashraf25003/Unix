    ...
    <>
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          {/* <button type="button" className="text-sm text-primary dark:text-dark-primary hover:underline">
            Forgot password?
          </button> */}
        </div>
        ...
        {/* <button
          type="button"
          className="w-full flex items-center justify-center space-x-2 py-2.5 border border-gray-300 dark:border-gray-700 rounded-xl hover:bg-gray-50 dark:hover:bg-dark-card transition-colors"
        >
