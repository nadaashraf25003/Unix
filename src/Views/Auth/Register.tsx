...
const Register = () => {
  ...
  const onSubmit = (data: RegisterForm) => {
    ...
    const payload: RegisterData = {
      ...
      sectionId:
        data.role === "Student" && data.sectionId ? Number(data.sectionId) : 0,
      stage:
        data.role === "Student" && selectedSection ? selectedSection.stage : 0,
    };
  ...
  return (
    <div className="space-y-6 max-w-md mx-auto">
      <form
        ...
        onSubmit={handleSubmit(onSubmit)} // <-- add this!
      >
        {/* Full Name */}
        <div>
